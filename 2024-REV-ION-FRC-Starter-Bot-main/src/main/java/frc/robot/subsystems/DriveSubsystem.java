...
public class DriveSubsystem extends SubsystemBase {
  ...
  public IMUAxis yawAxis = (IMUAxis.kY);
  ...
  SwerveDriveOdometry m_odometry =
      new SwerveDriveOdometry(
          ...
          Rotation2d.fromDegrees(m_gyro.getAngle(yawAxis)),
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(m_gyro.getAngle(yawAxis)).getDegrees();
  }
  ...
  public double getTurnRate() {
    return m_gyro.getRate(yawAxis) * (DriveConstants.kGyroReversed ? -1.0 : 1.0);
  }
}
